export default function Features11_8({
  ...
  const listOfFeatureIcons = [
    { icon: "flaticon-browser", key: "browser" },
    { icon: "flaticon-analytics", key: "analytics" },
    { icon: "flaticon-security", key: "security" },
    { icon: "flaticon-graphics", key: "graphics" },
  ];
  return (
    <>
                    ...
                    <div className="fbox-ico-wrap">
                      <div className="fbox-ico ico-50">
                        <div className="shape-ico color--theme">
                          {/* Vector Icon */}
                          <span className={listOfFeatureIcons[index]?.icon} />
                          {/* Shape */}
                          <svg
                            viewBox="0 0 200 200"
