        ...
        <div className='row justify-content-center'>
          <div className='col-xl-10'>
            ...
            <div className='txt-block legal-info'>
              ...
              {/* Text */}
              <p>
                Donec sodales nibh vel (the <span>&ldquo;Terms&rdquo;</span>)
                aliquet tristique purus justo suscipit mauris tempus sed laoreet
                nulla ante purus. Donec dolor and magna undo suscipit magna at
                tortor laoreet dignissim, undo porttitor massa quisque and
                mollis, sapien gravida aliquet ipsum ultrices aliquet lorem
                purus and vitae auris aliquam
              </p>
              {/* Text */}
              <p>
              ...
              <ul className='simple-list'>
                <li className='list-item'>
                  <p>
                    ...
                    laoreet turpis urna augue, viverra a augue eget diam
                    pulvinar
                  </p>
                </li>
                <li className='list-item'>
              ...
              <p>
                ...
                lacus ligula ipsum primis cubilia donec undo augue luctus vitae
                egestas a molestie donec libero sapien dapibus congue tempor
                undo quisque fusce cursus neque donec and ipsum porta diam lorem
                sodales an aliquam lacinia justo sapien congue aliquet and
                sodales a quaerat tortor lacinia egestas
              </p>
              {/* Title */}
              <h4 className='s-30 w-700'>
              ...
              <p>
                Sagittis augue congue egestas integer velna purus purus magna
                nec suscipit and egestas magna aliquam ipsum vitae purus justo
                lacus ligula ipsum primis cubilia donec and augue luctus congue
              </p>
              {/* Small Title */}
              <h5 className='s-24 w-700'>
