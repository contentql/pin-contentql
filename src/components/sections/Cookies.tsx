          ...
          <div className='col-xl-10'>
            ...
            <div className='txt-block legal-info'>
              ...
              <p>
                ...
                nec suscipit egestas magna undo aliquam ipsum vitae purus justo
                lacus ligula ipsum primis cubilia donec undo augue luctus vitae
                egestas a molestie donec libero
                <Link href='/privacy' className='color--theme'>
                  Privacy Policy
                </Link>{' '}
                tempor undo quisque fusce a cursus neque diam augue fusce sapien
                nulla a primis lacinia ipsum a molestie blandit and justo an
                aliquet eget molestie cursus quaerat
              </p>
              {/* Text */}
              <p>
              ...
              <ul className='simple-list'>
                ...
                <li className='list-item'>
                  <p>
                    Nemo ipsam egestas volute turpis dolores ut aliquam quaerat
                    sodales sapien congue augue egestas sagittis massa lorem
                    fusce cursus fusce nulla vitae massa placerat vulputate
                    purus
                  </p>
                </li>
                <li className='list-item'>
              ...
              <p>
                ...
                egestas a molestie donec libero sapien dapibus congue tempor
                undo quisque fusce cursus neque diam augue fusce sapien nulla a
                rimis lacinia ipsum a molestie blandit and justo an aliquet eget
